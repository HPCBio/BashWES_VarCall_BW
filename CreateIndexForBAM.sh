...
OUT_DIR_ROOT=$2
PathToFiles=$3 
SAMTOOLSDIR=/projects/sciteam/baib/builds/samtools-1.5
...
do
   ...
   echo -e "nohup $SAMTOOLSDIR/samtools index ${file} >  $OUT_DIR/logs/log.${file_name}.anisimov.command " > $OUT_DIR/logs/${file_name}.anisimov.command
